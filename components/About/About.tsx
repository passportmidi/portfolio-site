      ...
      <Grid>
        <Grid.Col span={{ base: 12, md: 8, sm: 6 }}>
          <Text pt="md">
            ...
            to deliver projects for clients. Since then, I’ve been expanding my
            knowledge into computer networks and cybersecurity through Skills
            for Hire Atlantic’s Cybersecurity certification, and full-stack web
            development through BrainStation’s Software Engineering diploma. In
            my free time, you’ll find me tinkering with Linux or teaching myself
            a new fibre art.
          </Text>
        </Grid.Col>
